  ...
  //---------------------SONG MENU----------------------------------------------
    ...
    if(switch_one_pressed){
      ...
      while(ALWAYS){ //doing black line detection until done with the black line
        //clear time counter to zero
        //while loop for pivot correcting back from right sensor leaving
        //assign current time count to temp time count for error correcting
        //if statement checking if left spin correction needed from correcting right pivot
      
        //clear time counter to zero
        //while loop for pivot correcting back from left sensor leaving
        //assign current time count to temp time count for error correcting
        //if statement checking if right spin correction needed from correcting right pivot
      
        //if both sensors on black then go forward (WHILE)
