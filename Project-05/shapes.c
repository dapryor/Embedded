...
// Compiler: Built with IAR Embedded Workbench Version: V4.10A/W32 (6.4.1)
//==============================================================================
  right_reverse_rate = SEVENTYFIVE_PERCENT; // turn ON RIGHT wheel forward
  left_forward_rate = SEVENTYFIVE_PERCENT; // turn ON LEFT wheel forward
...
// Compiler: Built with IAR Embedded Workbench Version: V4.10A/W32 (6.4.1)
//==============================================================================
  right_forward_rate = SEVENTYFIVE_PERCENT; // turn ON RIGHT wheel forward
  left_reverse_rate = SEVENTYFIVE_PERCENT; // turn ON LEFT wheel forward
