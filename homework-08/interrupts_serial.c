...
__interrupt void USCI_A0_ISR(void){
    ...
    switch(__even_in_range(UCA0IV,0x08)){
        ...
        case 4: // Vector 4 – TXIFG
            //temp = usb_tx_ring_wr0;
            //UCA0TXBUF= USB_Char_Tx0[temp]; // TX -> USB_Char_Tx character
            //if (++usb_tx_ring_wr0 >= (LARGE_RING_SIZE)){
            //    usb_tx_ring_wr0 = BEGINNING; // Circular buffer back to beginning
            //}
            break;
        default: break;
    }
